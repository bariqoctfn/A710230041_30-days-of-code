...
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QListWidget, QListWidgetItem, QSpinBox
...
class CafeOrderApp(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle('Cafe Order')
        self.setGeometry(100, 100, 400, 300)
        self.setWindowIcon(QIcon("USS.png"))
